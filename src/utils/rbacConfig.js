...
export const PERMISSIONS = {
  ...
  VIEW_PURCHASING: "view_purchasing", // 👈 NUEVO PERMISO
};
...
export const PERMISSION_LABELS = {
  ...
  [PERMISSIONS.VIEW_TICKETS]: "Mesa de Ayuda (Tickets)",
  [PERMISSIONS.VIEW_GROWTH]: "Growth Center (Marketing)",
  [PERMISSIONS.VIEW_PURCHASING]: "Centro de Compras (Inteligencia)", // 👈 ETIQUETA
};
...
export const ROLE_DEFAULTS = {
  ...
  DOCTOR: [
    ...
    PERMISSIONS.VIEW_GROWTH // 👈 Acceso concedido
  ],
  SALES: [
    PERMISSIONS.VIEW_DASHBOARD,
    PERMISSIONS.VIEW_PATIENTS,
